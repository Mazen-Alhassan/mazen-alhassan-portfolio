...
const companies: Company[] = [
  {
    ...
    logo: "https://carleton.ca/brand/wp-content/uploads/sites/3/carleton-logo.png",
    description: "IT Support Consultant"
  },
  {
    name: "LOCVM",
    website: "https://www.locvm.ca/",
    logo: "https://www.locvm.ca/desktop-logo.svg",
    description: "Full Stack Dev / QA Tester Intern"
  },
  {
    name: "Université Laval",
    website: "https://www.ulaval.ca/",
    logo: "https://www.ulaval.ca/sites/default/files/ul/images/logo-ul.svg",
