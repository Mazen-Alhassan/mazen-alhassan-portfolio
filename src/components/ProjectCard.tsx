...
export default function ProjectCard({
  ...
  return (
    ...
    >
      <div className={`h-2 bg-gradient-to-r ${gradient} rounded-full mb-6 animate-glow`}></div>
      ...
      <ul className="text-gray-400 text-sm space-y-1">
        {features.map((feature) => (
          <li key={feature} className="hover:text-gray-300 transition-colors duration-200">
            {feature}
          </li>
        ))}
      </ul>
