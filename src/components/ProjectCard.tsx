...
export default function ProjectCard({
  ...
  return (
    <div
      ref={tiltRef}
      className={`group glass p-6 rounded-2xl border border-gray-700/50 hover:border-gray-500/50 transition-all duration-500 transform-gpu magnetic ${
    ...
    >
      ...
      <h3 className="text-xl font-semibold text-white mb-4 group-hover:neon-white transition-all duration-300">
        {title}
      </h3>
      ...
      {websiteUrl && (
        <div className="flex items-center justify-center">
          <div className="flex items-center gap-2 text-gray-400 group-hover:text-gray-300 transition-colors duration-300 bg-gray-800/50 hover:bg-gray-700/50 px-4 py-2 rounded-full border border-gray-600/50 hover:border-gray-500/50">
            <svg
